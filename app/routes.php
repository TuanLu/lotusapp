...
$app->get('/phieuxuat/fetchVerifyProducts', 'PhieuxuatController:fetchVerifyProducts')->setName(Roles::roleAndRouter()['qlphieuxuat']['view']);
...
$app->get('/gantt/fetchTasksByMaRnd/{ma_rnd}', 'GanttController:fetchTasksByMaRnd');
